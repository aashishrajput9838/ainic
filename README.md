...
This project includes Firebase Authentication integration with the following features:
...
- `contexts/AuthContext.tsx` - Global authentication state provider
- `hooks/useAuth.ts` - Custom hook for authentication functions
- `components/AuthStatus.tsx` - Authentication status indicator
